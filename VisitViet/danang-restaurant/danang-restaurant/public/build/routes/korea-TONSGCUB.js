...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\routes\\\\korea.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1704303778972.5735";
}
var meta = ({
  data
}) => [{
...
function KoreaIndexPage() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, { customClass: "flex", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-full md:w-[calc(100%-200px)] md:px-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "h-full rounded-[10px] p-2 bg-[#f5f9f8] md:p-6 md:rounded-[40px] lg:flex", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "lg:w-[30%] overflow-y-scroll", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Category, { countrySlug: "korea", language, categorys: types }, void 0, false, {
        fileName: "app/routes/korea.tsx",
        lineNumber: 66,
        columnNumber: 13
      }, this) }, void 0, false, {
...
//# sourceMappingURL=/build/routes/korea-TONSGCUB.js.map
