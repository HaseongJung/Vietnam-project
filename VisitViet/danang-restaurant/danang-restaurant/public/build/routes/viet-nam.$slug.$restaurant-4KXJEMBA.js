...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\routes\\\\viet-nam.$slug.$restaurant.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1704441396531.756";
}
var meta = ({
  data
}) => [{
...
//# sourceMappingURL=/build/routes/viet-nam.$slug.$restaurant-4KXJEMBA.js.map
